...
//////////////////////////////////////////////////////
//6.36 — SliverAppBar & CustomScrollView (Collapsing Toolbar) Ans Submit Gmini
class Slivers extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Siyam Blogt")),
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            expandedHeight: 300,
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: ListTile(
                ...
                subtitle: const Text('August 20, 2025'),
              ),
            ),
          ),
          SliverList.builder(
            ...
            itemBuilder: (context, index) =>
                ListTile(title: Text('This is blog content line ${index + 1}')),
          ),
        ],
      ),
    );
